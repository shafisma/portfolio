    ...
    <section id="contact" className="relative py-32 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 mb-4">Or drop me an email</p>
          <a
            href="mailto:hello@shafi.dev"
            className="inline-flex items-center gap-2 text-lg text-indigo-400 hover:text-indigo-300 transition-colors font-medium"
          >
