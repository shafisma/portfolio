    ...
    <section id="about" className="relative py-20 px-4 sm:px-6 text-white overflow-hidden snap-start scroll-mt-24">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
          ...
          {/* 1. Profile Card */}
          <TiltCard className="md:col-span-1 min-h-[350px] md:min-h-[400px] rounded-3xl bg-[#111] border border-white/10 p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="flex gap-4 relative z-10">
              <button 
                onClick={copyEmail}
                data-cursor-text={isCopied ? "Copied!" : "Copy Email"}
                aria-label="Copy Email"
                className="p-2 rounded-full bg-white/5 hover:bg-white/20 transition-colors"
              >
                <FiMail size={20} />
              </button>
              <a href="https://github.com/shafisma" data-cursor-text="GitHub" aria-label="GitHub Profile" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-white/20 transition-colors"><SiGithub size={20} /></a>
              <a href="https://x.com/Shafigrate" data-cursor-text="Twitter / X" aria-label="X (Twitter) Profile" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-white/20 transition-colors"><SiX size={20} /></a>
            </div>
          </TiltCard>

          {/* 2. About Me Text Card */}
          <TiltCard className="md:col-span-2 rounded-3xl bg-[#0a0a0a] border border-white/10 p-6 md:p-10 flex flex-col justify-center gap-6">
             <div className="space-y-4">
                <h3 className="text-2xl font-bold text-white">Who I am</h3>
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                  I’m Shafi, a passionate developer digging deep into complex problems and solving them with software. My mission is to <a href="#projects" data-cursor-text="My Work" className="text-white hover:underline decoration-orange-500 underline-offset-4 transition-all">build tools</a> that empower people and businesses to achieve their goals. I approach every project with a focus on <a href="https://www.nngroup.com/articles/empathy-user/" target="_blank" rel="noopener noreferrer" data-cursor-text="Learn More" className="hover:text-white transition-colors border-b border-gray-700 hover:border-white">user empathy</a>, <a href="https://aws.amazon.com/what-is/scalability/" target="_blank" rel="noopener noreferrer" data-cursor-text="Learn More" className="hover:text-white transition-colors border-b border-gray-700 hover:border-white">scalability</a>, and <a href="https://web.dev/learn/performance" target="_blank" rel="noopener noreferrer" data-cursor-text="Learn More" className="hover:text-white transition-colors border-b border-gray-700 hover:border-white">performance</a>.
                </p>
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                  I specialize in full-stack development with a heavy focus on the frontend ecosystem—specifically <a href="https://nextjs.org" target="_blank" rel="noopener noreferrer" data-cursor-text="Next.js" className="text-white font-medium hover:underline decoration-green-500 underline-offset-4 transition-all">Next.js</a>, <a href="https://www.typescriptlang.org" target="_blank" rel="noopener noreferrer" data-cursor-text="TypeScript" className="text-white font-medium hover:underline decoration-blue-500 underline-offset-4 transition-all">TypeScript</a>, and <a href="https://tailwindcss.com" target="_blank" rel="noopener noreferrer" data-cursor-text="Tailwind" className="text-white font-medium hover:underline decoration-cyan-500 underline-offset-4 transition-all">Tailwind</a>. I love crafting interfaces that feel instant and alive.
                </p>
             </div>

             <div className="flex flex-wrap gap-3 mt-2">
                {["TypeScript", "Next.js", "Python", "Tailwind", "Open Source", "Async-first"].map((tag) => (
                  <span key={tag} data-cursor-text={tag} className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-gray-300 font-medium hover:bg-white/10 transition-colors">
                    {tag}
                  </span>
                ))}
             </div>
          ...
          <TiltCard 
             className="md:col-span-3 min-h-[250px] rounded-3xl bg-[#080808] border border-white/10 p-6 md:p-8 overflow-hidden relative flex flex-col md:flex-row items-center gap-6 md:gap-8"
          ...
          >
            <div className="flex-1 space-y-4 z-10 w-full">
              ...
              <p className="text-gray-400 text-sm max-w-sm">
                I work <a href="https://doist.com/blog/async-communication/" target="_blank" rel="noopener noreferrer" data-cursor-text="Read" className="text-gray-300 hover:text-white border-b border-gray-600 hover:border-white transition-colors">async-first</a> and am comfortable collaborating with teams in US, UK, and European time zones. 24-48h turnaround on <a href="#contact" data-cursor-text="Contact" className="text-gray-300 hover:text-white border-b border-gray-600 hover:border-white transition-colors">communications</a>.
              </p>
